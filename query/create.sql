...
--store.user_product
insert into store.store_user (id, userid, username, firstname, lastname, email, password, specialproduct, recurring, token) values (1, 'b2xrasd', 'klhomme0', 'Kimbra', 'L''Homme', 'klhomme0@scribd.com', '$2a$04$lWEwk5a6kUSRzPGdHrnWRuJv/maEypAnkwTJrppGk5x9MSwwOsLwK', true, true, '27c8cf05-8354-4b65-89b1-f8b82a615341');
insert into store.store_user (id, userid, username, firstname, lastname, email, password, specialproduct, recurring, token) values (2, 'rebajea', 'ewhicher1', 'Elora', 'Whicher', 'ewhicher1@gov.uk', '$2a$04$49McFz5UtXQkT/vMZVixbeF22sU4y6EE6ZI0XZEeo8HZwIjjJm1ji', false, false, '4d89ff31-a9c7-4e97-aa1d-484145ec34a2');
insert into store.store_user (id, userid, username, firstname, lastname, email, password, specialproduct, recurring, token) values (3, '7qr8lsq', 'jdecreuze2', 'Jasper', 'Decreuze', 'jdecreuze2@reverbnation.com', '$2a$04$tt0Yv7ntr0hzl7X.fF8bOOoRV4qlHd1VdcsT6N3z5VGwrJX7kd4Ga', true, true, 'be5b9997-237d-45e8-ad64-ae35f14bbd9f');
insert into store.store_user (id, userid, username, firstname, lastname, email, password, specialproduct, recurring, token) values (4, 'v3jjsv0', 'ctallman3', 'Cornell', 'Tallman', 'ctallman3@narod.ru', '$2a$04$rO3LjG8PMTFCULZFR34cNeMfhbKnjLjxJUfyRi3MQkUyKpMavVxuy', false, true, 'b3dcb83d-36f5-4470-a5fd-af4d7c5cb524');
insert into store.store_user (id, userid, username, firstname, lastname, email, password, specialproduct, recurring, token) values (5, 'tf0x3xc', 'cbaistow4', 'Colline', 'Baistow', 'cbaistow4@cnet.com', '$2a$04$vOua9YmADeMsWmh1T8ryQ.zzj3rMX5FkumOCUFRVF.HLJxuvnpASi', false, true, 'e20069e8-4b53-40f3-b909-aa0c0065bb18');
--store.product
