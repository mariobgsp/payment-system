package com.example.msinvoice.config.kafka.client;
...
public class KafkaConsumerConfig {
    ...
    @Bean(ApplicationConstant.BEAN_PAYMENT_EVENT_CONSUMER_FACTORY)
    public ConsumerFactory<String, String> createOrderConsumerFactory() {
        Map<String, Object> props = new HashMap<>();
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, bootstrapServers);
        props.put(ConsumerConfig.GROUP_ID_CONFIG, appProperties.getPAYMENTEVENT_KAFKA_GROUPID());
    ...
    @Bean(ApplicationConstant.BEAN_PAYMENT_EVENT_CONTAINER_FACTORY)
